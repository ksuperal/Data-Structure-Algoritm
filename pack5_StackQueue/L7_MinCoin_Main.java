...
import pack5_StackQueue.code.Coins;
...
public class L7_MinCoin_Main {
    ...
    public static void main(String[] args) {
        ...
        for (amount = 4; amount < 12; amount++) {
            ...
            System.out.println("amount " + amount + " uses " + minNumCoin2(amount,minCoinResidual));
            }
    ...
    static int minNumCoin(int amount) {
        ...
        for (Coins c : Coins.values()) {
            ...
            if (numCoin < coinsNeeded) {coinsNeeded = numCoin;} //ensure that the number of coins is the minimum
    ...
    static int minNumCoin2(int amount, int [] residual) {
    ...
    static void fasterBy() {
        ...
        System.out.print("amount = " + amount + " uses " + minNumCoin2(amount,residual));
        System.out.println(" elapse time = " + (int)(System.currentTimeMillis() - time));
        }
}
